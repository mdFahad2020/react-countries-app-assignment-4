export default function Header({ handleSort }) {
  return (
    <header
      ...
      className=" fixed right-0 left-0 flex items-center justify-between bg-[#2b3945] px-10 py-4 text-white"
    >
      ...
      <div className="">
        <input
          type="search"
          className="block p-2 w-48 md:w-72 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
